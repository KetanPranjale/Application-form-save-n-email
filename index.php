...
<!-- <script type="text/javascript" src="/js/themeswitchertool.js"></script> -->
	...
	a.button:hover { color: red; /*#F3A536;*/ }
	  a.button span { display:block; float:left; height:38px; border:none; }
	  .bigButtonLeft { background:url('/images/Bigbutton-left.png') no-repeat; width:16px; }
	  .bigButtonMiddle { line-height:30px; background:url('/images/Bigbutton-middle.png') repeat-x; color:white; white-space:nowrap; font-family: 'Georgia', 'Times New Roman'; font-size: 16px; }
	.bigButtonMiddle:hover { color: black; /* #F3A536 */}
	</style>
    ...
    $(function(){
			...
			$('a[rel*=facebox]').facebox({ loadingImage : upre + '/images/loading.gif', closeImage   : upre + '/images/closelabel.png' });
		});
